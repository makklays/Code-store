<?php
namespace eeuu/ukraine;

trait ValueEEUU()
{
  // Ценности ЕС (Европейского Союза)
  return [
      'ru' => [
          '1' => 'уважение к человеческому достоинству',
      ...
      'es' => [
          ...
          '2' => 'respeto de los derechos humanos',
          '3' => 'libertad',
          '4' => 'poder popular',
          '5' => 'igualdad',
          '6' => 'estado de derecho',
  ...
  // нас вырастил Ияков (Израиль) 12 колен  
  // наше свободное (вышли из рабства) 
  // куда идем?
  // от победы к победе 
  // 
  // это написала бабушка яга )) угага )))
}
